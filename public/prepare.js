...
var commandline = ['<form id=command><label><span class="cmd-prompt"></span><span autofocus autocapitalize=off spellcheck=false autocorrect=off contenteditable id="cmd-input"></span><span class=wait id="cmd-cursor">&nbsp;</span><input hidden autofocus></label></form>',
